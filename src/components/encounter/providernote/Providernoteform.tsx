// // src/components/encounter/providernote/Providernoteform.tsx
// "use client";
//
...
// };
//
// // Allowed statuses as a literal tuple -> union type
// const NOTE_STATUSES = ["draft", "final", "amended"] as const;
// type NoteStatus = (typeof NOTE_STATUSES)[number];
//
// const DEFAULT_TYPE_CODE = "34109-0"; // generic Note (safe default)
//
...
//                                              onCancel,
//                                          }: Props) {
//     // form fields that match backend DTO
...
//     const [noteDateTime, setNoteDateTime] = useState<string>(""); // ISO local: 2025-09-09T10:30
...
//             setNoteStatus((editing.noteStatus as NoteStatus) ?? "draft");
//             // backend returns "2025-09-09T10:30:00" → trim seconds for datetime-local
//             const dt = (editing.noteDateTime ?? "").replace(/:\d\d(\.\d+)?Z?$/, "");
//             setNoteDateTime(dt);
//             setAuthorPractitionerId(String(editing.authorPractitionerId ?? ""));
...
//
//         try {
//             // Build payload exactly like Bruno bodies
...
//                 noteStatus, // <-- now the correct union type
//                 noteDateTime, // keep as local ISO string (your backend accepts it)
//                 authorPractitionerId: authorPractitionerId
//                     ? Number(authorPractitionerId)
//                     : undefined,
...
//             className="space-y-4 rounded-2xl border p-4 bg-white shadow-sm"
//         >
//             <h3 className="text-lg font-semibold">
//                 {editing?.id
//                     ? isSigned
//                         ? "View Provider Note (Signed)"
//                         : "Edit Provider Note"
//                     : "Add Provider Note"}
//             </h3>
//
