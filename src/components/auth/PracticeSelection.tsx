      ...
      <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent bg-gray-800 text-white"
              />
              <svg
        ...
        {filteredTenants.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">No practices found matching &quot;{searchQuery}&quot;</p>
          </div>
        ) : (
          <div className="space-y-3">
            ...
            <div
              key={tenant}
              className="bg-gray-800 rounded-lg border-2 border-gray-700 hover:border-brand-500 transition-all duration-200 cursor-pointer p-4"
