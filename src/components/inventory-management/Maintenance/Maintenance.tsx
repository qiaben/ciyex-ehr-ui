...
export default function Maintenance() {
        ...
        (async () => {
            ...
            try {
                const res = await fetchWithAuth(
                    `${process.env.NEXT_PUBLIC_API_URL}/api/maintenance?page=${currentPage - 1}&size=${pageSize}`
                );
    ...
    async function createTask(e: React.FormEvent) {
        ...
        try {
            ...
            if (data.success) {
                ...
                setAlertData({
                    variant: "success",
                    title: "Task Created",
                    message: `${data.data.equipment} was added successfully.`,
                });
            } else {
        ...
        let next: "Open" | "In Progress" | "Done";
        ...
        try {
            ...
            await fetchWithAuth(`${process.env.NEXT_PUBLIC_API_URL}/api/maintenance/${id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ ...task, status: next }), // send full DTO with new status
            });
            ...
            setAlertData({
                ...
                message: `Task ${id} changed to ${next}.`,
            });
        } catch {
            setAlertData({
                variant: "error",
    ...
    return (
        <AdminLayout>
                ...
                <div className="flex items-center justify-between p-1">
                    ...
                    <Button                     className="h-8 px-3 text-sm rounded-lg bg-blue-600 text-white hover:bg-blue-700"
                                                onClick={() => setShowModal(true)}>+ New Task</Button>
                </div>
